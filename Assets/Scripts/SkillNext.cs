...
public class SkillNext : MonoBehaviour {
	...
	private bool shoots;
	private bool changeSpll;

	public void OnShoot(InputAction.CallbackContext context)
	{
		shoots = context.performed;

	}
	public void OnChangeSpell(InputAction.CallbackContext context)
	{
		changeSpll = context.performed;
	...
	void Update () {
		if(Input.GetKey(KeyCode.X)|| shoots)
		{
		...
		//	Next();
		if (Input.GetKeyDown(KeyCode.Z)|| changeSpll)
			Previous();
	}
	void SpawnVFX (){
		GameObject vfx;
